        ...
        <div class="caja clearfix">
          <div class="extras">
            <div class="orden">
              ...
              <input type="number"  id="camisa_evento" min="0" name="pedido_camisas" size="3" placeholder="0">      
            </div><!-- Orden-->
            <div class="orden">
              <label for="etiquetas">Paquete de 10 etiquetas $2<small>(HTML5, CSS3,JavaScript)</small></label>
              <input type="number"  id="etiquetas" min="0" name="pedido_etiquetas" size="3" placeholder="0">            
            </div><!-- Orden-->
            <div class="orden">

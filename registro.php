        ...
        <div class="caja clearfix">
          <div class="extras">
            <div class="orden">
              ...
              <input type="number"  id="camisa_evento" min="0" name="pedido_extra[camisas][cantidad]" size="3" placeholder="0">      
              <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
            </div><!-- Orden-->
            <div class="orden">
              <label for="etiquetas">Paquete de 10 etiquetas $2<small>(HTML5, CSS3,JavaScript)</small></label>
              <input type="number"  id="etiquetas" min="0" name="pedido_extra[etiquetas][cantidad]" size="3" placeholder="0">
          ...
          <div class="total">
            ...
            <input type="submit" id="button_registro" name="submit" class="button" value="Pagar">
          </div><!-- total -->
